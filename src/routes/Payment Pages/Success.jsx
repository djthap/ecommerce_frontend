			...
			const response = await fetch(
				'https://ecommerce-backend-o1vw.onrender.com/api/orderRoutes/',
				{
					...
					body: JSON.stringify({
						...
						cardHolderName:
							pendingCheckout.shippingInfo.cardHolderName,
						address: pendingCheckout.shippingInfo.address,
						email: pendingCheckout.shippingInfo.email,

						items: pendingCheckout.cartItems.map(
							(item) => item.product._id
						),
						totalPrice: pendingCheckout.cartItems.reduce(
		...
		<div style={containerStyle}>
			<div style={successContainerStyle}>
				...
				<p style={paragraphStyle}>
					Phone Number: {pendingCheckout.shippingInfo.phoneNumber}
				</p>
				<p style={paragraphStyle}>
					Address: {pendingCheckout.shippingInfo.address}
				</p>
