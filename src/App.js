...
import Success from './routes/Payment Pages/Success'
import Cancel from './routes/Payment Pages/Cancel'
				...
				<Route
					...
					element={
						<Layout
							loading={loading}
							setloading={setloading}
							element={<ViewProduct loading={loading}
							setloading={setloading} />}
						/>
					}
				/>
